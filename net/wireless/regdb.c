...
static const struct ieee80211_regdomain regdom_TW = {
	...
	.reg_rules = {
		REG_RULE(2402, 2472, 40, 3, 27, 0),
		REG_RULE(5270, 5330, 40, 6, 17, 
			NL80211_RRF_DFS | 0),
		REG_RULE(5490, 5730, 80, 6, 30, 
			NL80211_RRF_DFS | 0),
