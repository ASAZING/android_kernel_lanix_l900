...
@ -I /home/scraids/Kernel/android_kernel_lanix_l900/arch/arm/include
@ -I arch/arm/include/generated -I include
@ -I /home/scraids/Kernel/android_kernel_lanix_l900/arch/arm/include/uapi
@ -I arch/arm/include/generated/uapi
@ -I /home/scraids/Kernel/android_kernel_lanix_l900/include/uapi
@ -I include/generated/uapi -I arch/arm/mach-msm/include
@ -iprefix /home/scraids/Android/toolchain/arm-eabi-4.8/bin/../lib/gcc/arm-eabi/4.8/
@ -D__USES_INITFINI__ -D __KERNEL__ -D __LINUX_ARM_ARCH__=7 -U arm
@ -D CC_HAVE_ASM_GOTO -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(bounds)
@ -D KBUILD_MODNAME=KBUILD_STR(bounds)
@ -isystem /home/scraids/Android/toolchain/arm-eabi-4.8/bin/../lib/gcc/arm-eabi/4.8/include
@ -include /home/scraids/Kernel/android_kernel_lanix_l900/include/linux/kconfig.h
...
@ -Wno-bool-compare -Wno-maybe-uninitialized -Wframe-larger-than=1024
